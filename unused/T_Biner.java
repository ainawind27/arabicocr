...
public class T_Biner {
	...
	static public void main(String args[]) throws Exception {
		...
		int[][] chaincode = T_Binerisasi_dan_chaincode_1.binerisasi("D:\\filetraining\\zhangsuen\\timesnewroman_fa_diakhir_zhangsuen.png", 127);
		...
		for (int i = 0; i < chains.size(); i++) {
			if (chains.get(i).chain.length() >= 6) {
		...
		normalisasi.normalizedFinish(bodyChain);
