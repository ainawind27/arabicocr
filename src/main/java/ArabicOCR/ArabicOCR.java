...
public class ArabicOCR {
    ...
    public static String processSubword(MainbodySOSet meso, SegmentatorSubword segSubword, int i) throws Exception {
        ...
        for (int j=0;j<size;j++) {
            ...
            try {
                ImageIO.write(segCharacter.getInputImage_plain().getBufferedImage(), "bmp", new File(HMMFInal.Const.TEST_IMAGES +"/hasilsegmentasi/"+ i+"mainhasil.bmp"));
                ImageIO.write(segCharacter.getInputImage_withSecondary().getBufferedImage(), "bmp", new File(HMMFInal.Const.TEST_IMAGES +"/hasilsegmentasi/"+ i+"mainSechasil.bmp"));
                ImageIO.write(segCharacter.getInputImage_thin().getBufferedImage(), "bmp", new File(HMMFInal.Const.TEST_IMAGES +"/hasilsegmentasi/"+ i+"mainThinhasil.bmp"));
            } catch (Exception e) {
...
//    public static segmentate
    ...
    public static float test(String s, String expected) {
        ...
        for (int i=0;i<lis2.length;i++) {
            ...
            else if (lis2[i].equals(lis[i])) sumCorrect++;
        }
