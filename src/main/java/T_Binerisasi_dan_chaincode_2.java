...
public class T_Binerisasi_dan_chaincode_2 {
	 ...
	 static int[][] binerisasi(String fileInput, int threshold) {
	      try {
		   ...
		   {
			   //T_Binerisasi_dan_chaincode.binerisasi("D:\\lam.PNG", 127);
			   int [][]chaincode =  T_Binerisasi_dan_chaincode.binerisasi ("D:\\alif.PNG", 127);
