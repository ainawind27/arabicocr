...
public class XorExample {
    public static void main(String[] args) {
        ...
        input.putScalar(new int[]{0, 2}, 7.0/7.0);
        input.putScalar(new int[]{0, 3}, 4.0/7.0);
        input.putScalar(new int[]{0, 4}, 3.0/7.0);
        input.putScalar(new int[]{0, 5}, 5.0/7.0);
        input.putScalar(new int[]{0, 6}, 3.0/7.0);
        input.putScalar(new int[]{0, 7}, 3.0/7.0);
        input.putScalar(new int[]{0, 8}, 7.0/7.0);
        input.putScalar(new int[]{0, 9}, 0.0/7.0);
        input.putScalar(new int[]{0, 10}, 2.0/7.0);
        input.putScalar(new int[]{0, 11}, 7.0/7.0);
